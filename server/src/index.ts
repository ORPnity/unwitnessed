...
function broadcast(room: Room, data: object, excludeWs?: WebSocket): void {
...
function handleCreateRoom(ws: WebSocket, data: any): void {
...
function handleJoinRoom(ws: WebSocket, data: any): void {
...
function handleMessage(ws: WebSocket, data: any): void {
  ...
  broadcast(room, {
    ...
    messageId: data.messageId || randomBytes(8).toString('hex'),
  }, ws);
}
