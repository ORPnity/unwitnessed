  ...
  return (
    <div className="w-full max-w-lg fade-in">
      ...
      <div className="space-y-6">
        ...
        {/* Security notice */}
        <div className="border border-white/5 bg-white/[0.02] px-3 sm:px-4 py-3 text-white/20 text-[9px] sm:text-[10px] tracking-wider uppercase space-y-1">
          <p>• Share Room ID + Password securely</p>
